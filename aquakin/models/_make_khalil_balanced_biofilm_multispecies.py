...
# New model-level parameters (yields fixed from the literature; growth rates
...
# Replacement reactions. Stoichiometry strings use the model parameters; each
...
def main():
    ...
    net["model"]["name"] = "wats_sewer_khalil_paper_balanced_biofilm_multispecies"
