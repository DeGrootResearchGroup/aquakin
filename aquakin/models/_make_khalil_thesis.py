...
structure is the same as the shipped `wats_sewer_extended` model -- here we
...
def main():
    ...
    net["model"]["name"] = "wats_sewer_khalil_thesis"
    ...
    print(
        ...
        f"({net['model']['name']}, {len(net['reactions'])} reactions, "
