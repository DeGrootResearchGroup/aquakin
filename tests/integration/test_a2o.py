...
def test_autotrophs_grow_not_crash_under_aeration(asm2d):
    ...
    C = net.concentrations({
        "SO2": 6.0, "SF": 5.0, "SA": 2.0, "SNH4": 25.0, "SNO3": 1.0, "SPO4": 5.0,
        "SI": 30.0, "SALK": 7.0, "XH": 1800.0, "XPAO": 400.0, "XPP": 50.0,
        "XPHA": 5.0, "XAUT": 120.0, "XTSS": 3500.0}, base="zero")
    rates = net.rates(jnp.maximum(C, 0.0), net.default_parameters(),
                      {"T": jnp.array([293.15])}, 0)
...
def test_asm2d_grad_flows(asm2d):
    ...
    C0 = net.concentrations({
        ...
        "XPP": 150.0, "XPHA": 30.0, "XAUT": 120.0, "XTSS": 4000.0}, base="zero")
