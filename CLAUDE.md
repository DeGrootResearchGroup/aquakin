...
- `wats_sewer` — extended WATS sewer-process model (carbon/sulfur/nitrogen
  ...
  finite differences. **Still outstanding**: quantitative validation against
  the published model. First network to use a **state-derived pH** (see
  *Speciation / state-derived pH* below).
