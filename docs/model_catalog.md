...
- `asm2d` — ASM2D, ASM1 extended with biological phosphorus removal
  ...
  **autotroph and PP-uptake half-saturations** had been collapsed onto the
  ...
  source by [`scripts/verify_sumo_asm.py`](https://github.com/DeGrootResearchGroup/aquakin/blob/main/scripts/verify_sumo_asm.py), which
...
- `wats_sewer_khalil_paper` — paper-faithful re-implementation of the *published*
  ...
  [`models/_make_khalil_paper.py`](https://github.com/DeGrootResearchGroup/aquakin/blob/main/aquakin/models/_make_khalil_paper.py)
  ...
  [`models/_make_khalil_variants.py`](https://github.com/DeGrootResearchGroup/aquakin/blob/main/aquakin/models/_make_khalil_variants.py).
...
- `wats_sewer_khalil_paper_balanced` — the mass- and electron-balanced
  ...
  [`models/_make_khalil_balanced.py`](https://github.com/DeGrootResearchGroup/aquakin/blob/main/aquakin/models/_make_khalil_balanced.py)
...
- `wats_sewer_khalil_thesis` — the same complete WATS model + nitrate-dosing
  ...
  Generated by [`models/_make_khalil_thesis.py`](https://github.com/DeGrootResearchGroup/aquakin/blob/main/aquakin/models/_make_khalil_thesis.py)
